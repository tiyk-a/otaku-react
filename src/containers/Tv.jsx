  ...
  return (
    <div>
      <MediaQuery query="(min-width: 767px)">
        ...
        <Button className="button-pink" value="21" onClick={() => handleChange(21)} style={id === 21 ? selected : null}>Kinki Kids<span className='itemNumber'>{numbers[21] > 0 ? numbers[21] : ""}</span></Button></MediaQuery>
